            ...
            <div class="border-b border-gray-200 pb-6 mb-8">
                ...
                <form action="{{ route('company.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center mb-8">
                        <div class="mr-6">
                            ...
                            <div
                                ...
                                <img id="logo-preview"
                                    src="{{ $company->logo ? asset('storage/' . $company->logo) : asset('images/nexsecure.png') }}"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="structure" value="{{ $company->structure }}"
                            class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="tva_number" value="{{ $company->tva_number }}"
                            class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="siren" value="{{ $company->siren }}"
                            class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            class="px-6 py-3 bg-indigo-600 text-white rounded-md shadow hover:bg-indigo-700 transition ease-in-out duration-200">
                            Mettre à jour
                        </button>
                    </div>
                </form>
